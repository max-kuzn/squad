...
def save_comfort_data(comfort_data):
    np.savez(F_COMFORT_TRAIN_PATH,
            context          = comfort_data[0][0],
            context_len      = comfort_data[0][1],
            context_int_features = comfort_data[0][2],
            context_float_features = comfort_data[0][3],
            question         = comfort_data[1][0],
            question_len     = comfort_data[1][1],
            answer_begin     = comfort_data[2][0],
            answer_end       = comfort_data[2][1]
    )
# save_comfort_data
...
def make_comfort_data(data):
    ...
    context_data = (context, context_len, context_int_features, context_float_features)
...
def main():
    ...
    print("Done.")
    print("Processing...")
    data = make_comfort_data(data['train'])
    print("Done.")
    print("Saving...")
